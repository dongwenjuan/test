...
type ActivationEndpointStatus struct {
	...
	ActivationEPNum  int     `json:"activationEPnum,omitempty"`
	Subsets []ActivationEndpointSubset `json:"subsets,omitempty" protobuf:"bytes,2,rep,name=subsets"`
}

type ActivationEndpointSubset struct {
    []corev1.EndpointAddress   `json:",inline"`
    []corev1.EndpointPort      `json:",inline"`
}
