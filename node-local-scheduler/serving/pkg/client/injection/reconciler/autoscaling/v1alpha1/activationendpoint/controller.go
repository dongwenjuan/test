...
import (
	...
	activationendpoint "knative.dev/serving/pkg/client/injection/informers/autoscaling/v1alpha1/activationendpoint"
)

const (
	defaultControllerAgentName = "activationendpoint-controller"
	defaultFinalizerName       = "activationendpoints.autoscaling.internal.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	activationendpointInformer := activationendpoint.Get(ctx)

	lister := activationendpointInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "autoscaling.internal.knative.dev.ActivationEndpoint"),
	)
